...
def destroy(from_id, to_id, current_user_email: str, db: Session, get_neo4j):
    ...
    util.check_no_mother(from_id, person_male)

    get_neo4j.delete_from_mother_to_son(from_id, to_id)
...
def create(request: schemas.PersonEdge, db: Session, current_user_email: str, get_neo4j):
    ...
    get_neo4j.create_from_mother_to_son(request.from_id, request.to_id)
